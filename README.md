...
### React Implementation WIKI - https://github.com/NaveenPantra/call-recording-waveform/wiki
...
1. Right-click on the audio waveform to add comments - The context menu will show the options.
2. The participant's timeline will move according to the audio player's.
3. Seek to a particular time in the audio player.
